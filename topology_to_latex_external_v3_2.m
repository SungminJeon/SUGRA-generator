...
Print["  NEW: Repeating pattern compression"];
Print["  NEW: Single node full 4-position support"];
...
Print["========================================"];
Print["  Topology to LaTeX Converter v3.2"];
Print["  (WITH EXTERNAL CURVES - RED)"];
Print["========================================"];
Print[];
Print["NEW FEATURES in v3.2:"];
Print["  - Repeating pattern compression:"];
Print["    so otimes{1,1} so otimes{1,1} so"];
Print["    -> so (otimes{1,1} so)^2"];
Print["  - Single node full 4-position support"];
Print[];
Print["USAGE:"];
